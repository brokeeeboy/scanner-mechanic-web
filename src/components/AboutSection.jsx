    ...
    <section id="nosotros" className="py-20 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="lg:order-2" data-aos="fade-left">
            ...
            <div className="space-y-6">
              <div className="flex items-start" data-aos="fade-up" data-aos-delay="100">
                <div className="bg-jocars-yellow rounded-full p-2 mr-4">
                  <svg className="w-5 h-5 text-jocars-dark" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="lg:order-1 relative" data-aos="zoom-in" data-aos-delay="200">
            <div className="absolute -inset-4 bg-gradient-to-tr from-jocars-yellow/20 to-transparent rounded-lg blur-xl opacity-70"></div>
            <div className="relative bg-black/40 backdrop-blur-sm border border-jocars-yellow/20 rounded-xl overflow-hidden shadow-xl">
              <div className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center" data-aos="fade-right" data-aos-delay="300">
                    <div className="h-1 w-1 bg-jocars-yellow rounded-full mr-2"></div>
                  ...
                  <div className="flex items-center" data-aos="fade-right" data-aos-delay="500">
                    <div className="h-1 w-1 bg-jocars-yellow rounded-full mr-2"></div>
                ...
                <div className="mt-8 text-center" data-aos="fade-up" data-aos-delay="700">
